...
def Transfer_Method(opt, current_step: int, tot_step: int, input_pil: Image = None):
...
def Remove_Method(opt, current_step: int, tot_step: int, input_pil: Image = None):
...
def Replace_Method(opt, current_step: int, tot_step: int, input_pil: Image = None):
...
def Move_Method(opt, current_step: int, tot_step: int, input_pil: Image = None):
...
def Add_Method(opt, current_step: int, tot_step: int, input_pil: Image = None):
