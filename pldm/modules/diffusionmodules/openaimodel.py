...
from pldm.modules.diffusionmodules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
from pldm.modules.attention import SpatialTransformer
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, adapter_features=None, append_to_context=None,**kwargs):
        """
