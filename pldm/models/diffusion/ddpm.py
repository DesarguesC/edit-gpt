...
from pldm.util import log_txt_as_img, exists, default, ismap, isimage, mean_flat, count_params, instantiate_from_config
from pldm.modules.ema import LitEma
from pldm.modules.distributions.distributions import normal_kl, DiagonalGaussianDistribution
from pldm.models.autoencoder import VQModelInterface, IdentityFirstStage, AutoencoderKL
from pldm.modules.diffusionmodules.util import make_beta_schedule, extract_into_tensor, noise_like
...
class LatentDiffusion(DDPM):
    ...
    def apply_model(self, x_noisy, t, cond, adapter_features=None, append_to_context=None, return_ids=False, **kwargs):
        ...
        if hasattr(self, "split_input_params"):
            ...
            x_recon = self.model(x_noisy, t, adapter_features=adapter_features, append_to_context=append_to_context, **cond, **kwargs)
...
class DiffusionWrapper(pl.LightningModule):
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None, adapter_features=None, append_to_context=None, **kwargs):
