...
def generate_example(opt, new_noun, expand_agent=None, use_inpaint_adapter=False, ori_img: Image = None, cond_mask=None, **kwargs) -> Image:
    ...
    if opt.use_adapter:
        ...
        pipe = DiffusionPipeline.from_pretrained(f"{opt.XL_base_path}/stabilityai/stable-diffusion-xl-base-1.0", torch_dtype=torch.float16, use_safetensors=True, variant="fp16", local_files_only=True)
        pipe.to("cuda")
